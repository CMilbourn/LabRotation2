...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
flowchange_transpose=(array_flowchange')


Table_flowchange_transpose= array2table(flowchange_transpose,'RowNames',mriparameters,'VariableNames',Headers2)
writetable(flowchange_transpose, sprintf('%s/array_flowchange_transpose_table_%s.csv',FiguresOut,(datestr(clock,'yyyy-mm-dd_HH-MM-SS'))))
