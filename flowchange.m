...
%                 %during hypercapnia window
                start_dur_ind=find(bbb_array(:,1)>(events_start(mriparam)+2),1); %full window = 2 to 5mins 
                end_dur_ind=find(bbb_array(:,1)>(events_start(mriparam)+5),1); 
                ...
                start_aft_ind=find(bbb_array(:,1)>(events_start(mriparam)+5),1); %full window = 5 to 7 mins 
